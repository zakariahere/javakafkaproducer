package com.elzakaria.kafkaconsumer.lessons.lesson02_deserialization;
...
/**
 * Lesson 02: Deserialization & Type Safety
 *
 * Handle different serialization formats safely.
 */
@Component
public class Lesson02Deserialization implements ConsumerLesson {

    private static final String TOPIC = "lesson02-deserialization";
    private static final String GROUP_ID = "lesson02-group";
