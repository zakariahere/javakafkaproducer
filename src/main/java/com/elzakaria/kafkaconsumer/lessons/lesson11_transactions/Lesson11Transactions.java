package com.elzakaria.kafkaconsumer.lessons.lesson11_transactions;
...
/**
 * Lesson 11: Transactions & Exactly-Once Semantics (EOS)
 *
 * Implement bulletproof exactly-once processing.
 */
@Component
public class Lesson11Transactions implements Lesson {

    private static final String TOPIC = "lesson11-transactions";
    private static final String GROUP_ID = "lesson11-group";
