package com.elzakaria.kafkaconsumer.lessons.lesson14_kafka_listener;
...
/**
 * Lesson 14: Spring @KafkaListener Annotation
 *
 ...
 */
@Component
public class Lesson14KafkaListener implements Lesson {

    private static final String TOPIC_SIMPLE = "lesson14-simple";
    private static final String TOPIC_ADVANCED = "lesson14-advanced";
    private static final String GROUP_ID = "lesson14-group";
    ...
    public Lesson14KafkaListener(KafkaListenerEndpointRegistry kafkaListenerEndpointRegistry) {
    ...
    private void demonstrateListenerLifecycleControl() throws Exception {
        ...
        var simpleContainer = kafkaListenerEndpointRegistry.getListenerContainer("lesson14-simple");
        if (simpleContainer != null) {
            System.out.println("\n  Listener 'lesson14-simple':");
     ...
     */
    @KafkaListener(topics = TOPIC_SIMPLE, groupId = GROUP_ID + "-simple", id = "lesson14-simple")
