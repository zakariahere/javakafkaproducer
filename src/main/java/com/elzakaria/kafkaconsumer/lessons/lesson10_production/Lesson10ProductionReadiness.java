package com.elzakaria.kafkaconsumer.lessons.lesson10_production;
...
/**
 * Lesson 10: Production Readiness - Monitoring & Operations
 *
 * Deploy consumers in production safely.
 */
@Component
public class Lesson10ProductionReadiness implements Lesson {

    public static final String TOPIC = "lesson10-lag";
