package com.elzakaria.kafkaconsumer.lessons.lesson08_performance;
...
/**
 * Lesson 08: Performance Tuning & Metrics
 *
 * Optimize consumer throughput and latency.
 */
@Component
public class Lesson08Performance implements Lesson {

    private static final String TOPIC = "lesson08-performance";
