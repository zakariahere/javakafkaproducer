package com.elzakaria.kafkaconsumer.lessons.lesson06_state_management;
...
/**
 * Lesson 06: Offset & State Management
 *
 * Manage application state and ensure consistency.
 */
@Component
public class Lesson06StateManagement implements Lesson {

    private static final String TOPIC = "lesson06-state";
